...
function loadImages() {
		...
		var imageList = [
			...
			{tileType: TILE_GRASS_MINIMAP, theFile: "grass-minimap.png"},
			{tileType: TILE_BLOCKED_MINIMAP,  theFile: "blocked-minimap.png"},
			{tileType: TILE_TREASURE,  theFile: "treasure.png"},
			{tileType: TILE_WATER,  theFile: "water.png"},
			{tileType: TILE_WATER_MINIMAP, theFile: "water-minimap.png"},
