...
function drawQuestOneCompletionScreen() {
  ...
  colorText("Comforted of your town being safe, you want to go check on", 147, 250, "green", font = "20px Georgia");
  colorText("your Princess.", 144, 300, "green", font = "20px Georgia");
  colorText("Press Enter to Continue.", 450, 500, "red", font = "20px Georgia");
